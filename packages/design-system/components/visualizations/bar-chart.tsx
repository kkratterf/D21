...
import {
  getYAxisDomain,
} from '@d21/design-system/lib/y-axis';
...
type RechartsPayload = {
  ...
  readonly type?: LegendType | undefined;
  readonly dataKey?: string | number | ((obj: Record<string, unknown>) => unknown);
  readonly payload?: Record<string, unknown>;
};

const ChartLegend = (
  { payload }: { payload: readonly RechartsPayload[] | undefined },
...
const BarChart = React.forwardRef<HTMLDivElement, BarChartProps>(
  (props, forwardedRef) => {
    ...
    function onBarClick(data: any, _: unknown, event: React.MouseEvent) {
