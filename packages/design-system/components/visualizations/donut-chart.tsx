...
import type { AvailableChartColorsKeys } from "@d21/design-system/lib/chart"
import {
            ...
            >
                <ResponsiveContainer className="size-full">
                    ...
                    >
                        ...
                        <Pie
                            className={cn(
                                "stroke-icon-inverse [&_.recharts-pie-sector]:outline-none",
