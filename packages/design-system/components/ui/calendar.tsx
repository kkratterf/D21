  ...
  ({ onClick, icon, disabled, ...props }: NavigationButtonProps, forwardedRef) => {
    ...
    return (
      <button
        ...
        onClick={onClick}
        {...props}>
        <Icon className="stroke-2 stroke-icon-active size-4 shrink-0" />
      </button>
    );
  }
);
          ...
          return (
            <div className="flex justify-between items-center text-md">
              ...
              <div
                role="presentation"
                aria-live="polite"
                className="font-medium tabular-nums capitalize text">
          ...
          return (
            <button
              ...
              {today && (
                <span
                  className={cn(
                    "text-md absolute inset-x-1/2 bottom-1.5 h-0.5 w-4 -translate-x-1/2 rounded-lg",
                    {
                      "bg-brand": !selected,
