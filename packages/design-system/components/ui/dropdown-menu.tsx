  ...
  <DropdownMenuPrimitives.CheckboxItem
    ...
    <span className="right-3 absolute flex justify-center items-center size-4">
      <DropdownMenuPrimitives.ItemIndicator>
        <Check aria-hidden="true" className="size-full text-brand shrink-0" />
      </DropdownMenuPrimitives.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitives.CheckboxItem>
...
>(({ className, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.RadioItem
    ...
    <span className="right-3 absolute flex justify-center items-center size-2">
      <Circle
        aria-hidden="true"
        className="group-data-[state=unchecked]/DropdownMenuRadioItem:hidden group-data-[state=checked]/DropdownMenuRadioItem:flex fill-current size-full text-brand shrink-0"
      />
    </span>
    {children}
  </DropdownMenuPrimitives.RadioItem>
