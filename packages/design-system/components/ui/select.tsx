...
import { cn, focusInput, hasErrorInput } from "@d21/design-system/lib/utils";
...
>(({ className, ...props }, forwardedRef) => (
  <SelectPrimitives.ScrollUpButton
    ...
    {...props}>
    <ChevronUp className="stroke-icon group-hover:stroke-icon-hover size-4 shrink-0" aria-hidden="true" />
  </SelectPrimitives.ScrollUpButton>
));
...
>(({ className, ...props }, forwardedRef) => (
  <SelectPrimitives.ScrollDownButton
    ...
    {...props}>
    <ChevronDown className="stroke-icon group-hover:stroke-icon-hover size-4 shrink-0" aria-hidden="true" />
  </SelectPrimitives.ScrollDownButton>
));
